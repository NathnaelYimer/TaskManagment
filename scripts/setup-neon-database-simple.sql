-- Simple database setup for Task Management Application
...
-- Insert default admin user (using simple INSERT)
INSERT INTO users_sync (id, email, name, created_at, updated_at) 
VALUES ('admin-001', 'nathnaelyimer@gmail.com', 'Nathan Yimer', NOW(), NOW());
